...
const NotFoundPage = () => {
  return (
    <div className="bg-atv-principal flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-10 md:py-32">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-atv-tercero">
           Lo sentimos, pero la página que estás buscando por ahora no está habilitada o no existe.
          </p>
        </div>
